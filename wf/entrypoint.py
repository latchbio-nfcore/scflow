...
def nextflow_runtime(
    ...
    qc_min_ribo: typing.Optional[float],
    mult_doublet_rate: typing.Optional[float],
    integ_small_clust_thresh: typing.Optional[int],
    manifest: str,
    input: str,
    ensembl_mappings: str,
    ctd_path: str,
    celltype_mappings: typing.Optional[str],
    reddim_genes_yml: typing.Optional[str],
    species: str,
    qc_key_colname: str,
    qc_factor_vars: str,
    qc_min_library_size: int,
    qc_max_library_size: str,
    qc_min_features: int,
    qc_max_features: str,
    qc_max_ribo: float,
    qc_max_mito: str,
    ...
    amb_retain: str,
    amb_lower: int,
    amb_alpha_cutoff: float,
    amb_niters: int,
    amb_expect_cells: int,
    mult_find_singlets: str,
    mult_singlets_method: str,
    mult_vars_to_regress_out: str,
    mult_pca_dims: int,
    mult_var_features: int,
    mult_dpk: int,
    mult_pK: float,
    merge_plot_vars: str,
    merge_facet_vars: str,
    merge_outlier_vars: str,
    integ_method: str,
    integ_unique_id_var: str,
    integ_take_gene_union: str,
    integ_remove_missing: str,
    integ_num_genes: int,
    integ_combine: str,
    integ_keep_unique: str,
    integ_capitalize: str,
    integ_use_cols: str,
    integ_k: int,
    integ_lambda: float,
    integ_thresh: float,
    ...
    integ_knn_k: int,
    integ_k2: int,
    integ_prune_thresh: float,
    integ_ref_dataset: str,
    integ_min_cells: int,
    integ_quantiles: int,
    integ_nstart: int,
    integ_resolution: int,
    integ_dims_use: str,
    integ_dist_use: str,
    integ_center: str,
    integ_categorical_covariates: str,
    integ_input_reduced_dim: str,
    reddim_input_reduced_dim: str,
    reddim_reduction_methods: str,
    reddim_vars_to_regress_out: str,
    reddim_umap_pca_dims: int,
    reddim_umap_n_neighbors: int,
    reddim_umap_n_components: int,
    reddim_umap_init: str,
    reddim_umap_metric: str,
    reddim_umap_n_epochs: int,
    reddim_umap_learning_rate: int,
    reddim_umap_min_dist: float,
    reddim_umap_spread: float,
    reddim_umap_set_op_mix_ratio: float,
    reddim_umap_local_connectivity: int,
    reddim_umap_repulsion_strength: int,
    reddim_umap_negative_sample_rate: int,
    reddim_umap_fast_sgd: str,
    reddim_tsne_dims: int,
    reddim_tsne_initial_dims: int,
    reddim_tsne_perplexity: int,
    reddim_tsne_theta: float,
    reddim_tsne_stop_lying_iter: int,
    reddim_tsne_mom_switch_iter: int,
    reddim_tsne_max_iter: int,
    reddim_tsne_pca_center: str,
    reddim_tsne_pca_scale: str,
    reddim_tsne_normalize: str,
    reddim_tsne_momentum: float,
    reddim_tsne_final_momentum: float,
    reddim_tsne_eta: int,
    reddim_tsne_exaggeration_factor: int,
    clust_cluster_method: str,
    clust_reduction_method: str,
    clust_res: float,
    clust_k: int,
    clust_louvain_iter: int,
    cta_clusters_colname: str,
    cta_cells_to_sample: int,
    cta_unique_id_var: str,
    cta_celltype_var: str,
    cta_facet_vars: str,
    cta_metric_vars: str,
    cta_top_n: int,
    dge_de_method: str,
    dge_mast_method: str,
    dge_min_counts: int,
    dge_min_cells_pc: float,
    dge_rescale_numerics: str,
    dge_pseudobulk: str,
    dge_celltype_var: str,
    dge_sample_var: str,
    dge_dependent_var: str,
    dge_ref_class: str,
    dge_confounding_vars: str,
    dge_random_effects_var: str,
    dge_fc_threshold: float,
    dge_pval_cutoff: float,
    dge_force_run: str,
    dge_max_cores: str,
    ipa_enrichment_tool: str,
    ipa_enrichment_method: str,
    ipa_enrichment_database: str,
    dirich_unique_id_var: str,
    dirich_celltype_var: str,
    dirich_dependent_var: str,
    dirich_ref_class: str,
    dirich_var_order: str,
    plotreddim_reduction_methods: str,
    reddimplot_pointsize: float,
    reddimplot_alpha: float,
) -> None:
    try:
        ...
        if nextflow_log.exists():
            ...
            if name is None:
                ...
                remote = LPath(
                    urljoins(
                        "latch:///your_log_dir/nf_nf_core_scflow", name, "nextflow.log"
                    )
                )
...
def nf_nf_core_scflow(
    ...
    mult_doublet_rate: typing.Optional[float],
    integ_small_clust_thresh: typing.Optional[int],
    manifest: str = "./refs/Manifest.txt",
    input: str = "./refs/SampleSheet.tsv",
    ensembl_mappings: str = "https://raw.githubusercontent.com/nf-core/test-datasets/scflow/assets/ensembl_mappings.tsv",
    ctd_path: str = "https://s3-eu-west-1.amazonaws.com/pfigshare-u-files/28033407/ctd_v1.zip",
    celltype_mappings: typing.Optional[str] = "./conf/celltype_mappings.tsv",
    reddim_genes_yml: typing.Optional[str] = "./conf/reddim_genes.yml",
    species: str = "human",
    qc_key_colname: str = "manifest",
    qc_factor_vars: str = "seqdate",
    qc_min_library_size: int = 250,
    qc_max_library_size: str = "adaptive",
    qc_min_features: int = 100,
    qc_max_features: str = "adaptive",
    qc_max_ribo: float = 1.0,
    qc_max_mito: str = "adaptive",
    qc_min_counts: int = 2,
    qc_min_cells: int = 2,
    qc_drop_unmapped: str = "True",
    qc_drop_mito: str = "True",
    qc_drop_ribo: str = "false",
    qc_nmads: float = 4.0,
    amb_find_cells: str = "true",
    amb_retain: str = "auto",
    amb_lower: int = 100,
    amb_alpha_cutoff: float = 0.001,
    amb_niters: int = 10000,
    amb_expect_cells: int = 3000,
    mult_find_singlets: str = "true",
    mult_singlets_method: str = "doubletfinder",
    mult_vars_to_regress_out: str = "nCount_RNA,pc_mito",
    mult_pca_dims: int = 10,
    mult_var_features: int = 2000,
    mult_dpk: int = 8,
    mult_pK: float = 0.02,
    merge_plot_vars: str = "total_features_by_counts,total_counts,pc_mito,pc_ribo",
    merge_facet_vars: str = "NULL",
    merge_outlier_vars: str = "total_features_by_counts,total_counts",
    integ_method: str = "Liger",
    integ_unique_id_var: str = "manifest",
    integ_take_gene_union: str = "false",
    integ_remove_missing: str = "true",
    integ_num_genes: int = 3000,
    integ_combine: str = "union",
    integ_keep_unique: str = "false",
    integ_capitalize: str = "false",
    integ_use_cols: str = "true",
    integ_k: int = 30,
    integ_lambda: float = 5.0,
    integ_thresh: float = 0.0001,
    integ_max_iters: int = 100,
    integ_nrep: int = 1,
    integ_rand_seed: int = 1,
    integ_knn_k: int = 20,
    integ_k2: int = 500,
    integ_prune_thresh: float = 0.2,
    integ_ref_dataset: str = "NULL",
    integ_min_cells: int = 2,
    integ_quantiles: int = 50,
    integ_nstart: int = 10,
    integ_resolution: int = 1,
    integ_dims_use: str = "NULL",
    integ_dist_use: str = "CR",
    integ_center: str = "false",
    integ_categorical_covariates: str = "individual,diagnosis,region,sex",
    integ_input_reduced_dim: str = "UMAP",
    reddim_input_reduced_dim: str = "PCA,Liger",
    reddim_reduction_methods: str = "tSNE,UMAP,UMAP3D",
    reddim_vars_to_regress_out: str = "nCount_RNA,pc_mito",
    reddim_umap_pca_dims: int = 30,
    reddim_umap_n_neighbors: int = 35,
    reddim_umap_n_components: int = 2,
    reddim_umap_init: str = "spectral",
    reddim_umap_metric: str = "euclidean",
    reddim_umap_n_epochs: int = 200,
    reddim_umap_learning_rate: int = 1,
    reddim_umap_min_dist: float = 0.4,
    reddim_umap_spread: float = 0.85,
    reddim_umap_set_op_mix_ratio: float = 1.0,
    reddim_umap_local_connectivity: int = 1,
    reddim_umap_repulsion_strength: int = 1,
    reddim_umap_negative_sample_rate: int = 5,
    reddim_umap_fast_sgd: str = "false",
    reddim_tsne_dims: int = 2,
    reddim_tsne_initial_dims: int = 50,
    reddim_tsne_perplexity: int = 150,
    reddim_tsne_theta: float = 0.5,
    reddim_tsne_stop_lying_iter: int = 250,
    reddim_tsne_mom_switch_iter: int = 250,
    reddim_tsne_max_iter: int = 1000,
    reddim_tsne_pca_center: str = "true",
    reddim_tsne_pca_scale: str = "false",
    reddim_tsne_normalize: str = "true",
    reddim_tsne_momentum: float = 0.5,
    reddim_tsne_final_momentum: float = 0.8,
    reddim_tsne_eta: int = 1000,
    reddim_tsne_exaggeration_factor: int = 12,
    clust_cluster_method: str = "leiden",
    clust_reduction_method: str = "UMAP_Liger",
    clust_res: float = 0.001,
    clust_k: int = 50,
    clust_louvain_iter: int = 1,
    cta_clusters_colname: str = "clusters",
    cta_cells_to_sample: int = 10000,
    cta_unique_id_var: str = "individual",
    cta_celltype_var: str = "cluster_celltype",
    cta_facet_vars: str = "manifest,diagnosis,sex,capdate,prepdate,seqdate",
    cta_metric_vars: str = "pc_mito,pc_ribo,total_counts,total_features_by_counts",
    cta_top_n: int = 5,
    dge_de_method: str = "MASTZLM",
    dge_mast_method: str = "bayesglm",
    dge_min_counts: int = 1,
    dge_min_cells_pc: float = 0.1,
    dge_rescale_numerics: str = "true",
    dge_pseudobulk: str = "false",
    dge_celltype_var: str = "cluster_celltype",
    dge_sample_var: str = "manifest",
    dge_dependent_var: str = "group",
    dge_ref_class: str = "Control",
    dge_confounding_vars: str = "cngeneson,seqdate,pc_mito",
    dge_random_effects_var: str = "NULL",
    dge_fc_threshold: float = 1.1,
    dge_pval_cutoff: float = 0.05,
    dge_force_run: str = "false",
    dge_max_cores: str = "'null'",
    ipa_enrichment_tool: str = "WebGestaltR",
    ipa_enrichment_method: str = "ORA",
    ipa_enrichment_database: str = "GO_Biological_Process",
    dirich_unique_id_var: str = "individual",
    dirich_celltype_var: str = "cluster_celltype",
    dirich_dependent_var: str = "group",
    dirich_ref_class: str = "Control",
    dirich_var_order: str = "Control,Low,High",
    plotreddim_reduction_methods: str = "UMAP_Liger",
    reddimplot_pointsize: float = 0.1,
    reddimplot_alpha: float = 0.2,
) -> None:
    """
    nf-core/scflow
    ...
    nextflow_runtime(
        ...
        mult_dpk=mult_dpk,
        mult_pK=mult_pK,
        merge_plot_vars=merge_plot_vars,
        merge_facet_vars=merge_facet_vars,
        merge_outlier_vars=merge_outlier_vars,
        integ_method=integ_method,
        integ_unique_id_var=integ_unique_id_var,
        integ_take_gene_union=integ_take_gene_union,
        integ_remove_missing=integ_remove_missing,
        integ_num_genes=integ_num_genes,
        integ_combine=integ_combine,
        integ_keep_unique=integ_keep_unique,
        integ_capitalize=integ_capitalize,
        integ_use_cols=integ_use_cols,
        integ_k=integ_k,
        integ_lambda=integ_lambda,
        integ_thresh=integ_thresh,
        integ_max_iters=integ_max_iters,
        integ_nrep=integ_nrep,
        integ_rand_seed=integ_rand_seed,
        integ_knn_k=integ_knn_k,
        integ_k2=integ_k2,
        integ_prune_thresh=integ_prune_thresh,
        integ_ref_dataset=integ_ref_dataset,
        integ_min_cells=integ_min_cells,
        integ_quantiles=integ_quantiles,
        integ_nstart=integ_nstart,
        integ_resolution=integ_resolution,
        integ_dims_use=integ_dims_use,
        integ_dist_use=integ_dist_use,
        integ_center=integ_center,
        integ_small_clust_thresh=integ_small_clust_thresh,
