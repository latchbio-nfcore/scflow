...
**nf-core/scflow** is a bioinformatics best-practice analysis pipeline for Complete analysis workflow for single-cell/nuclei RNA-sequencing data..
...
3. Download the pipeline and test it on a minimal dataset with a single command:
   ...
   ```bash
   nextflow run nf-core/scflow -profile test,YOURPROFILE --outdir <OUTDIR>
   ```
...
4. Start running your own analysis!
   ...
   ```bash
   nextflow run nf-core/scflow --input samplesheet.csv --outdir <OUTDIR> --genome GRCh37 -profile <docker/singularity/podman/shifter/charliecloud/conda/institute>
   ```
